...
with tabs[0]:  # Single Job Analysis tab
    ...
    # Job title input with clear UI
    st.markdown("Enter any job title to analyze")
    search_job_title = st.text_input("Enter your job title", "", key="job_title_search")
...
with tabs[1]:  # Job Comparison tab
    ...
    new_job = st.text_input("Enter a job title and press Enter to add to comparison", key="compare_job_input")
